...
public class Problem1 {
	...
	//Hint: use concat
	public static List<List<String>> elementsInJustOne(List<String> list1, List<String> list2) {
		return Stream.of(list1).filter(e -> !list2.contains(e)).collect(Collectors.toList());
	}
